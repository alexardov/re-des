...
Det här **solarpunkmanifestet** är en kreativ återanvändning av idéer om solarpunk skrivna av många människor. Dessa idéer kan främst hittas i _Solarpunk: a reference guide_ vilken kan hittas [här](https://medium.com/solarpunks/solarpunk-a-reference-guide-8bcf18871965) och i _Solarpunk: Notes towards a Manifesto_, vilken kan hittas [här](https://hieroglyph.asu.edu/2014/09/solarpunk-notes-toward-a-manifesto/).
