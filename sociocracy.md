...
1. **Equivalence**: All members are equal within the group organization.

2. **Effectiveness**: The group's focus is on policies and actions that help it fulfill the group's vision, mission and objectives.

3. **Transparency**: Everyone has access to the policies, the meeting minutes, etc. There are no secrets. This supports equivalence, effectiveness and co-leadership responsibilities.
...
2. **Circle**. The sociocratic structure is based on circles.
...
1. The thicker the edge of the bubble, the more important the bubble.
2. The darker the color of the bubble, the more important the bubble.
...
1. Vision – Mission – Aims – **Green**
2. Circles and Double link – **Red** and **Blue**
3. Elections without candidates – **Purple**
4. Consent decision making – **Orange**
